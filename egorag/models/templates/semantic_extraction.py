...
# Important Notes:
- Character names might vary across episodic triples (e.g., "person_1" might be revealed as "Anna" in later triples). Deduce if different names refer to the same character and use a consistent name in your semantic triples (preferring real names over placeholders).
